...
Label pressure and acceleration, then click **Save** to write `./data/tag-label/{id}-labeled.csv`.
...
## Run labeling checks in trainset

Use the **Check** button in the trainset app header to run the built-in checks while you label.
