...
## Label on trainset shiny app

Label pressure and acceleration. Then click on save to create the label csv file in `/18LX-labeled.csv`
...
Edit and export label in trainset and simply run the same chunk until you're happy with it! This principle (edit your label file and re-run the same chunk) is valid throughout this script.
:::
